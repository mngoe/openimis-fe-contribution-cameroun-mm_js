...
import React$1, { Component, Fragment, useState } from 'react';
import { ConstantBasedPicker, formatPageQuery, graphql, formatMutation, formatGQLString, formatJsonField, withModulesManager, withHistory, TextInput, AmountInput, PublishedComponent, NumberInput, FormPanel, FormattedMessage as FormattedMessage$1, Helmet, formatMessageWithValues, ProgressOrError, Form, journalize, coreConfirm, historyPush } from '@openimis/fe-core';
...
var PaymentOperatorPicker = /*#__PURE__*/function (_Component) {
  ...
  _createClass(PaymentOperatorPicker, [{
    ...
    value: function render() {
      return /*#__PURE__*/React$1.createElement(ConstantBasedPicker, _extends({
        module: "contribution",
...
var ContributionMasterPanel = /*#__PURE__*/function (_FormPanel) {
  ...
  _createClass(ContributionMasterPanel, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React$1.createElement(Fragment, null, !!edited && !!edited.policy && !!edited.policy.value && /*#__PURE__*/React$1.createElement(Grid, {
        container: true,
        ...
        xs: 3,
        className: classes.item
      }, /*#__PURE__*/React$1.createElement(AmountInput, {
        module: "contribution",
        ...
        xs: 3,
        className: classes.item
      }, /*#__PURE__*/React$1.createElement(PublishedComponent, {
      ...
      })), !!edited && edited.payType == 'M' && /*#__PURE__*/React$1.createElement(Grid, {
        item: true,
        xs: 3,
        className: classes.item
      }, /*#__PURE__*/React$1.createElement(PublishedComponent, {
        ...
        xs: 3,
        className: classes.item
      }, /*#__PURE__*/React$1.createElement(NumberInput, {
        module: "contribution",
...
var ContributionMasterPanel$1 = withModulesManager(withHistory(injectIntl(withTheme(withStyles(styles$3)(ContributionMasterPanel)))));
...
var SaveContributionDialog = function SaveContributionDialog(_ref) {
  ...
  return /*#__PURE__*/React$1.createElement(Dialog, {
    open: !!contribution,
    onClose: onCancel
  }, /*#__PURE__*/React$1.createElement(DialogTitle, null, /*#__PURE__*/React$1.createElement(FormattedMessage$1, {
    module: "contribution",
    id: "saveContributionDialog.title"
  })), /*#__PURE__*/React$1.createElement(DialogContent, null, amount < policyValue && /*#__PURE__*/React$1.createElement(React$1.Fragment, null, step === 1 && /*#__PURE__*/React$1.createElement(DialogContentText, null, /*#__PURE__*/React$1.createElement(FormattedMessage$1, {
    module: "contribution",
    id: "saveContributionDialog.messageLower"
  })), step === 2 && /*#__PURE__*/React$1.createElement(DialogContentText, null, /*#__PURE__*/React$1.createElement(FormattedMessage$1, {
    module: "contribution",
    id: "saveContributionDialog.messageLowerConfirm"
  }))), amount >= policyValue && /*#__PURE__*/React$1.createElement(DialogContentText, null, amount === policyValue && /*#__PURE__*/React$1.createElement(FormattedMessage$1, {
    module: "contribution",
    id: "saveContributionDialog.messageEqual"
  }), amount > policyValue && /*#__PURE__*/React$1.createElement(FormattedMessage$1, {
    module: "contribution",
    id: "saveContributionDialog.messageHigher"
  }))), /*#__PURE__*/React$1.createElement(DialogActions, null, amount >= policyValue && /*#__PURE__*/React$1.createElement(Button, {
    onClick: function onClick(e) {
      return onConfirm();
    },
    className: classes.primaryButton,
    autoFocus: true
  }, /*#__PURE__*/React$1.createElement(FormattedMessage$1, {
    module: "contribution",
    id: "saveContributionDialog.ok.button"
  })), amount < policyValue && /*#__PURE__*/React$1.createElement(React$1.Fragment, null, step === 1 && /*#__PURE__*/React$1.createElement(Button, {
    onClick: function onClick(e) {
      return setStep(2);
    },
    className: classes.primaryButton,
    ...
    module: "contribution",
    id: "saveContributionDialog.ok.button"
  })), step === 2 && /*#__PURE__*/React$1.createElement(React$1.Fragment, null, /*#__PURE__*/React$1.createElement(Button, {
    onClick: function onClick(e) {
  ...
  })))), step === 1 && /*#__PURE__*/React$1.createElement(Button, {
    onClick: onCancel,
...
var SaveContributionDialog$1 = injectIntl(withTheme(withStyles(styles$2)(SaveContributionDialog)));
...
var ContributionForm$1 = withHistory(withModulesManager(connect(mapStateToProps$2, mapDispatchToProps$1)(injectIntl(withTheme(withStyles(styles$1)(ContributionForm))))));
...
var ContributionPage = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ContributionPage, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React$1.createElement(ContributionForm$1, {
        overview: overview,
...
var ContributionPage$1 = withHistory(withModulesManager(connect(mapStateToProps$1, mapDispatchToProps)(injectIntl(withTheme(withStyles(styles)(ContributionPage))))));
  ...
  _createClass(ContributionOverviewPage, [{
    ...
    value: function render() {
      ...
      var actions = [{
        ...
        icon: /*#__PURE__*/React$1.createElement(Edit, null),
        onlyIfDirty: false
      }];
      return /*#__PURE__*/React$1.createElement(ContributionPage$1, _extends({}, this.props, {
        readOnly: true,
        overview: true,
        actions: actions
      }));
...
var ContributionOverviewPage$1 = withHistory(withModulesManager(connect(mapStateToProps)(ContributionOverviewPage)));
